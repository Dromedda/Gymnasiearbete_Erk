...
#region Attack
	...
	if (attacking) {
		...
		var bullet = instance_create_layer(x + lengthdir_x(attack_distance, attack_dir), y + lengthdir_y(attack_distance, attack_dir), "Enemy", obj_enemy_bullet_damage_collider);
