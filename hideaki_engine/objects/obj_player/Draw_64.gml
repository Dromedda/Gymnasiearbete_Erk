#region Draw Ammo
	...
	*/
	...
	var ammo_scale = 0.8; 
	var ammo_rot = 0; 
	var ammo_x_base = (32 * ammo_scale);
	var ammo_y_base = (64);
	var ammo_x_pos_mult = (8* ammo_scale); 	
...
#region Draw Health
	...
	var heart_scale = 1; 
	var heart_rot = 0; 
	var heart_x_base = (32 * heart_scale);
	var heart_y_base = (32 * heart_scale);
	var heart_x_pos_mult = (24 * heart_scale); 	
